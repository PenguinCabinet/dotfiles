...
clientkeys = gears.table.join(
    ...
    --awful.key({ modkey, "Control" }, "Right", function (c) c:swap(awful.client.next(1)) end,
    --          {description = "move to Right", group = "client"}),
    --awful.key({ modkey, "Control" }, "Left", function (c) c:swap(awful.client.next(-1)) end,
